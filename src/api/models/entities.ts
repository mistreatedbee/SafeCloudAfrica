...
export type InspectionRunItem = {
  ...
  inspection_method?: 'physical-observation' | 'record-review' | 'interview' | 'other' | null;
  ...
  due_date?: string | null;
  status: 'open' | 'in-progress' | 'awaiting-evidence' | 'under-review' | 'approved' | 'closed' | 'overdue';
